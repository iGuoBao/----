...
int main(void)
{
    ...
    /*完胜*/ static char test5[100] = {'O', '1', 'L', '2', 'R', '1', 'K', '2', 'L', 't', 'w', 'w', 'w',  'f','w', 'O','B', 'd', 'w', 'w', 'w',  'A', '1', 'K', 't', 'w', 'w', 'w', 'L','L','1','w', 'f', 'w','O', 'B', 'd', 'x','w', 'w', 'w',  'A', '1', 'L', '1', 'R', '6','L','L','1','R','1','K','t','w','w','w','R','f','w','O','B','w','d','w','w','w','A','1','L','2','K','t','w','w','w','A','2','R','1','f','w','O' ,'S'};
