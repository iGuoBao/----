...
int main(void)
{
    ...
    /*完胜*/ static char test5[100] = {'O', '1', 'L', '2', 'R', '1', 'K', '2', 'L', 'T', 'w', 'f','w', 'O','B', 'D', 'w',  'A', '1', 'K', 'T', 'w',  'L','L','1','w', 'f', 'w','O', 'B', 'D', 'x','w',  'A', '1', 'L', '1', 'R', '6','w','f','w','b','L','L','1','R','1','K','t','w','R','y','f','w','O','B','w','d','w','w','A','1','L','2','K','t','w','w','A','2','R','1','f','w','O' ,'S'};
