 ...
 */
static const int16_t s_directions[8][2] = {
    {1, 0},   // X+方向：向前（列+1，行不变）
    {0, 1},   // Y+方向：向左（列不变，行+1）
    {-1, 0},  // X-方向：向后（列-1，行不变）
    {0, -1},  // Y-方向：向右（列不变，行-1）
...
uint8_t AStar_FindPath(PathPoint_t start_mm, PathPoint_t goal_mm, Path_t *path)
{
    ...
    while (s_open_count > 0) {
        ...
        for (uint8_t i = 0; i < 8; i++) {
            ...
            // 计算移动代价（直线或对角线）
            float move_cost = (i < 4) ? ASTAR_COST_STRAIGHT : ASTAR_COST_DIAGONAL;
...
static float heuristic(AStar_GridPoint_t a, AStar_GridPoint_t b)
{
    ...
    // 对角距离：D * (dx + dy) + (D2 - 2*D) * min(dx, dy)
    // 其中 D=10（直线代价），D2=14（对角线代价）
    int16_t min_dxy = (dx < dy) ? dx : dy;
    return ASTAR_COST_STRAIGHT * (dx + dy) + 
           (ASTAR_COST_DIAGONAL - 2.0f * ASTAR_COST_STRAIGHT) * min_dxy;
}
...
static void AStar_SetStaticObstacles(void)
{
    // 生成的障碍物设置代码
    // 总共 113 个障碍物
    // 坐标系：右下角(0,0)，X轴向上，Y轴向左
    AStar_SetObstacle(25, 39);
    AStar_SetObstacle(25, 38);
    AStar_SetObstacle(25, 37);
    AStar_SetObstacle(25, 36);
    AStar_SetObstacle(25, 35);
    AStar_SetObstacle(25, 4);
    AStar_SetObstacle(25, 3);
    AStar_SetObstacle(25, 2);
    AStar_SetObstacle(25, 1);
    AStar_SetObstacle(25, 0);
    AStar_SetObstacle(24, 39);
    AStar_SetObstacle(24, 38);
    AStar_SetObstacle(24, 37);
    AStar_SetObstacle(24, 36);
    AStar_SetObstacle(24, 35);
    AStar_SetObstacle(24, 4);
    AStar_SetObstacle(24, 3);
    AStar_SetObstacle(24, 2);
    AStar_SetObstacle(24, 1);
    AStar_SetObstacle(24, 0);
    AStar_SetObstacle(23, 39);
    AStar_SetObstacle(23, 38);
    AStar_SetObstacle(23, 37);
    AStar_SetObstacle(23, 36);
    AStar_SetObstacle(23, 35);
    AStar_SetObstacle(23, 4);
    AStar_SetObstacle(23, 3);
    AStar_SetObstacle(23, 2);
    AStar_SetObstacle(23, 1);
    AStar_SetObstacle(23, 0);
    AStar_SetObstacle(22, 24);
    AStar_SetObstacle(22, 23);
    AStar_SetObstacle(22, 22);
    AStar_SetObstacle(22, 21);
    AStar_SetObstacle(22, 20);
    AStar_SetObstacle(22, 19);
    AStar_SetObstacle(22, 18);
    AStar_SetObstacle(22, 17);
    AStar_SetObstacle(22, 16);
    AStar_SetObstacle(22, 15);
    AStar_SetObstacle(22, 14);
    AStar_SetObstacle(17, 39);
    AStar_SetObstacle(17, 38);
    AStar_SetObstacle(17, 37);
    AStar_SetObstacle(17, 36);
    AStar_SetObstacle(17, 35);
    AStar_SetObstacle(17, 4);
    AStar_SetObstacle(17, 3);
    AStar_SetObstacle(17, 2);
    AStar_SetObstacle(17, 1);
    AStar_SetObstacle(17, 0);
    AStar_SetObstacle(16, 39);
    AStar_SetObstacle(16, 38);
    AStar_SetObstacle(16, 37);
    AStar_SetObstacle(16, 36);
    AStar_SetObstacle(16, 35);
    AStar_SetObstacle(16, 19);
    AStar_SetObstacle(16, 4);
    AStar_SetObstacle(16, 3);
    AStar_SetObstacle(16, 2);
    AStar_SetObstacle(16, 1);
    AStar_SetObstacle(16, 0);
    AStar_SetObstacle(15, 39);
    AStar_SetObstacle(15, 38);
    AStar_SetObstacle(15, 37);
    AStar_SetObstacle(15, 36);
    AStar_SetObstacle(15, 35);
    AStar_SetObstacle(15, 4);
    AStar_SetObstacle(15, 3);
    AStar_SetObstacle(15, 2);
    AStar_SetObstacle(15, 1);
    AStar_SetObstacle(15, 0);
    AStar_SetObstacle(9, 24);
    AStar_SetObstacle(9, 23);
    AStar_SetObstacle(9, 22);
    AStar_SetObstacle(9, 21);
    AStar_SetObstacle(9, 20);
    AStar_SetObstacle(9, 19);
    AStar_SetObstacle(9, 18);
    AStar_SetObstacle(9, 17);
    AStar_SetObstacle(9, 16);
    AStar_SetObstacle(9, 15);
    AStar_SetObstacle(9, 14);
    AStar_SetObstacle(8, 39);
    AStar_SetObstacle(8, 38);
    AStar_SetObstacle(8, 37);
    AStar_SetObstacle(8, 36);
    AStar_SetObstacle(8, 35);
    AStar_SetObstacle(8, 4);
    AStar_SetObstacle(8, 3);
    AStar_SetObstacle(8, 2);
    AStar_SetObstacle(8, 1);
    AStar_SetObstacle(8, 0);
    AStar_SetObstacle(7, 39);
    AStar_SetObstacle(7, 38);
    AStar_SetObstacle(7, 37);
    AStar_SetObstacle(7, 36);
    AStar_SetObstacle(7, 35);
    AStar_SetObstacle(7, 4);
    AStar_SetObstacle(7, 3);
    AStar_SetObstacle(7, 2);
    AStar_SetObstacle(7, 1);
    AStar_SetObstacle(7, 0);
    AStar_SetObstacle(6, 39);
    AStar_SetObstacle(6, 38);
    AStar_SetObstacle(6, 37);
    AStar_SetObstacle(6, 36);
    AStar_SetObstacle(6, 35);
    AStar_SetObstacle(6, 4);
    AStar_SetObstacle(6, 3);
    AStar_SetObstacle(6, 2);
