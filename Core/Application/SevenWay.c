...
int SevenWay_Read(void)
{
	...
	if(seven_datas[0]!=0x75)return 0xff;
	seven_ff=seven_datas[1];
	check_data=seven_datas[2];
	seven_data=seven_datas[3];
	seven_data=seven_data<<8|seven_datas[4];
	if(!seven_datas[2]&0x20)return (power(seven_data));
	if((seven_datas[2]&0x20))return -1*power(seven_data);
	#else
	uint8_t data ;
	int Receive_data = 0;
...
//        if ((data & 28) == 28)
//            Receive_data = 0;    // 0011100
//        else if ((data & 56) == 56)
//            Receive_data = 10;   // 0111000
//        else if ((data & 14) == 14)
//            Receive_data = -10;  // 0001110
//        else if ((data & 122) == 122)
//            Receive_data = 20;   // 1110000
//        else if ((data & 7) == 7)
//            Receive_data = -20;  // 0000111
//        else if ((data & 24) == 24)
//            Receive_data = 5;    // 0011000
//        else if ((data & 12) == 12)
//            Receive_data = -5;   // 0001100
//        else if ((data & 48) == 48)
//            Receive_data = 15;   // 0110000
//        else if ((data & 6) == 6)
//            Receive_data = -15;  // 0000110
//        else if ((data & 96) == 96)
//            Receive_data = 25;   // 1100000
//        else if ((data & 3) == 3)
//            Receive_data = -25;  // 0000011
//        else if ((data & 8) == 8)
//            Receive_data = 0;    // 0001000
//        else if ((data & 16) == 16)
//            Receive_data = 10;   // 0010000
//        else if ((data & 4) == 4)
//            Receive_data = -10;  // 0000100
//        else if ((data & 32) == 32)
//            Receive_data = 20;   // 0100000
//        else if ((data & 2) == 2)
//            Receive_data = -20;  // 0000010
//        else if ((data & 64) == 64)
//            Receive_data = 30;   // 1000000
//        else if ((data & 1) == 1)
//            Receive_data = -30;  // 0000001
//        else
//            Receive_data = 0;    // 0000000

        // 将处理后的值存入全局变量
//        sevenway_data = Receive_data;
			}			
}
...
void error_calculate(){
	...
	if((seven_ff&0XFF)!=0x7F)sevenway_data=-cumulate/js*10;
	else sevenway_data=prav_data;
