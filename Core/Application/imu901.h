...
#define imu901_uart_receive(data, len)	HAL_UART_Receive(&huart3, data, len, 0xffff)	/*!< 串口i接收数据API */
#define imu901_uart_send(data, len)		HAL_UART_Transmit(&huart3, data, len, 0xffff)	/*!< 串口发送数据API */
